...
helga.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:ftrol})
break
...
`
sendButLocation(from, `${menu}`, "*𝚉𝚞𝚔𝚊𝙲𝚑𝚊𝚗 𝚅5.0.1*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`ping`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'pornhub':
            ...
            reply (mess.wait)
              ...
              buttonsMessage = {footerText:'𝚉𝚞𝚔𝚊𝙲𝚑𝚊𝚗 𝚅5.0.1', imageMessage: imageMsg,
...
case 'nsfw':
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						...
						helga.sendMessage(from, `𝚉𝚞𝚔𝚊𝙲𝚑𝚊𝚗 𝚅5.0.1`, text)
